                        ...
                        <form action="index.php?page=personalinfo-submit" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="father_name" class="form-control" <?php if(isset($row['father_name'])){ echo "value = '". $row['father_name']."'";  } ?>  required>
                                </div>

                                <!-- Mother Name -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Mother Name</label>
                                    <input type="text" name="mother_name" class="form-control" <?php if(isset($row['mother_name'])){ echo "value = '". $row['mother_name']. "'" ;  } ?> required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" name="dob" class="form-control" <?php if(isset($row['dob'])){ echo "value = '". $row['dob']. "'" ;  } ?> required>
                                </div>

                                <!-- Nationality -->
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Nationality</label>
                                    <input type="text" name="nationality" <?php if(isset($row['nationality'])){ echo "value = '". $row['nationality']. "'" ;  } ?> class="form-control">
                                </div>

                                <!-- Religion -->
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Religion</label>
                                    <input type="text" name="religion" <?php if(isset($row['religion'])){ echo "value = '". $row['religion']. "'" ;  } ?> class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="nid" class="form-control" <?php if(isset($row['nid'])){ echo "value = '". $row['nid']. "'" ;  } ?> >
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="birth_registration" class="form-control" <?php if(isset($row['birth_registration'])){ echo "value = '". $row['birth_registration']. "'" ;  } ?>>
                                </div>

                                <!-- Passport -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Passport No</label>
                                    <input type="text" name="passport_no" class="form-control" <?php if(isset($row['passport_no'])){ echo "value = '". $row['passport_no']. "'" ;  } ?>>
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-3 h-100">
                                        ...
                                        <h6 class="mb-0"><?= $row['father_name'] ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-3 h-100">
                                        ...
                                        <h6 class="mb-0"><?= $row['mother_name']   ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 border rounded-3 text-center">
                                        ...
                                        <h6 class="mt-1"><?= $row['nationality']   ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 bg-light rounded-3 text-center">
                                        ...
                                        <h6 class="mt-1"><?= $row['marital_status']   ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 border rounded-3">
                                        ...
                                        <h6 class="mb-0"><?= $row['birth_registration']   ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 border rounded-3">
                                        ...
                                        <h6 class="mb-0"><?= $row['passport_no']   ?></h6>
                                    </div>
                                </div>
