...
<div class="col-md-3 col-lg-2 bg-light min-vh-100 p-3 shadow-sm">
    ...
    <div style="height:65vh; overflow:scroll; scrollbar-width:none;">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                data-bs-toggle="collapse" href="#managejob">
                    <span><i class="fa fa-user-cog me-2 text-info"></i> Manage</span>
                    <i class="fa fa-angle-down"></i>
                </a>
                        ...
                        <li class="nav-item "><a class="nav-link text-muted d-flex justify-content-between align-items-center"  data-bs-toggle="collapse" href="#ExamManage">Manage Exam & Admit<i class="fa fa-angle-down"></i></a>
                            <div class="collapse" id="ExamManage">
                                <ul class="nav  flex-column" >
                                    ...
                                    <li class="ps-3"><a class="nav-link text-muted" href="index.php?page=exmCirculars">Assigned Venue</a></li>
                                    <li class="ps-3"><a class="nav-link text-muted" href="index.php?">Set center rooms building</a></li>
